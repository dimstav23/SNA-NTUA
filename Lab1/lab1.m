...
[rg_node_str,rg_str_dist,rg_avg,rg_max_str]=strenth_graph(full(W_rg),180);
...
[~,degree_cent_reg1]=cumulativecentrality(degree_cent_reg,180);
[~,betw_cent_reg1]=cumulativecentrality(betw_cent_reg,180);
[~,closs_cent_reg1]=cumulativecentrality(closs_cent_reg,180);
[~,eigen_cent_reg1]=cumulativecentrality(eigen_cent_reg,180);
subplot(4,1,1);
cdfplot(full(degree_cent_reg));
title('Deegree centrality REG');
subplot(4,1,2);
cdfplot(betw_cent_reg);
title('Closeness centrality REG');
subplot(4,1,3);
cdfplot(closs_cent_reg);
title('Betwwness centrality REG');
subplot(4,1,4);
cdfplot(full(eigen_cent_reg));
