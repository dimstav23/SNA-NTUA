function start(beta,gamma,S_0,I_0,R_00)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
param.beta = beta; % set the parameter 'beta' of the model
param.r = gamma;    % set the parameter 'r' of the model
...
%
initial.S = S_0;	% set the initial value of 'S'
initial.I = I_0;	% set the initial value of 'I'
initial.R = R_00;	% set the initial value of 'R'
...
title(model_title);
legend(legend_texts);
X=['gamma =' num2str(gamma)];
title(X)
saveas(gcf,['./SIR/' X '.png']);
